...
function alerta(elemento) {
    ...
    var city = elemento.innerText;
    cityname.innerText = elemento.innerText;

    alert("Cargando informe meteorológico de "+city);
}
...
function TempSelect (){
    ...
    for (let i=0; i<8; i++){
        var elemento_temp = document.querySelector(`#temp`+i); //#tem0 -> span class="max" id="temp0" 
